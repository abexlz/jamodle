...
(function (global) {
  ...
  const TIERS = {
    wooden: {
      ...
      prizes: [
        { id: 'coins-3', type: 'coins', amount: 3, weight: 22, icon: '🪙' },
        { id: 'coins-5', type: 'coins', amount: 5, weight: 18, icon: '🪙' },
        ...
        { id: 'hint-1', type: 'hintToken', amount: 1, weight: 7, icon: '💡' },
    ...
    original: {
      ...
      prizes: [
        ...
        { id: 'coins-10', type: 'coins', amount: 10, weight: 16, icon: '🪙' },
    ...
    mega: {
      ...
      prizes: [
        { id: 'coins-15', type: 'coins', amount: 15, weight: 16, icon: '🪙' },
        { id: 'coins-25', type: 'coins', amount: 25, weight: 14, icon: '🪙' },
        ...
        { id: 'xp-30', type: 'xp', amount: 30, weight: 12, icon: '⭐' },
        ...
        { id: 'buff-coin', type: 'buff', amount: 1, buffId: 'coinBoost2x15', weight: 2, icon: '⚡' },
      ],
    },
  };
