...
(function (global) {
  ...
  const PRESSABLE =
    ...
    '.wheel-spin-btn, .wheel-done-btn, .chest-room-buy-btn, .daily-gift-done-btn, .daily-gift-claim-btn, ' +
    '.menu-wheel-nav, .menu-calendar-nav, .menu-hud-coins, .menu-daily-gift-nav, ' +
