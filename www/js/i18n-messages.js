...
(function (global) {
  ...
  "en": {
    ...
    "menu": {
      ...
      "battle": {
        ...
        "multiplayerSub": "Jump into a live 1v1",
        "custom": "Friendly Match",
        "customSub": "Challenge a friend",
    ...
    "relatedWords": {
      ...
      "answerTtsOn": "Answer sound on — tap to mute",
      "answerTtsOff": "Answer sound off — tap to unmute",
      "swapPhoto": "Replace this photo",
      "swapPhotoUsed": "Already replaced",
      ...
      "chainRecapWords": "{{count}} words linked",
      "nextChainTitle": "Next up: {{title}}",
      ...
      "hintLabel": "Hint",
      "hintAria": "Reveal one letter for {{count}} coins",
      "hintTokenAria": "Reveal one letter with 1 hint token ({{count}} left)",
      "hintAdLabel": "Watch ad",
      "hintAdAria": "Watch a short ad to reveal one letter",
      "hintAdConfirm": "Watch a short ad to reveal one letter? (Demo — no ad will play.)",
      "hintInsufficient": "Not enough coins.",
      "hintInsufficientTokens": "Not enough hint tokens.",
      "hintUnavailable": "No letter left to reveal.",
      "chains": {
    ...
    "match": {
      ...
      "resultsDailyNextWord": "Daily Day {{n}} · New word tomorrow at midnight (KST)",
      ...
      "hints": {
        ...
        "meaningBtn": "MEANING",
        "cost": "{{n}} coins",
        "costAria": "Each hint costs {{count}} coins",
    ...
    "matchTurn": {
      ...
      "seriesScore": "Series {{opp}}–{{my}}",
      "firstTo": "First to {{n}}",
      "roundWin": "Round won! 🎉",
      "roundLoss": "Round lost",
      "roundPlayerWins": "{{name}} wins",
    ...
    "dailyGift": {
      "title": "Daily Gift",
      "subtitle": "Days {{start}}–{{end}} · Week {{week}} — keep logging in!",
      "returnTomorrow": "Return tomorrow for the next reward!",
      "streakBroken": "Streak reset — start again from day 1!",
      "trackLabel": "7-day login reward track",
      "dayLabel": "Day {{day}}",
      "today": "Today",
      "tomorrow": "Tomorrow",
      "claim": "Claim",
    ...
    "shop": {
      ...
      "tabItems": "Items",
      "tabGetCoins": "Get coins",
      "packCoins": "{{n}} coins",
      "buyPack": "Buy {{n}} coins for {{price}}",
      "packGranted": "+{{n}} coins added!",
      "packBadge": {
        "popular": "Popular",
        "best": "Best value"
      },
      "watchAdTitle": "Watch ad · +{{n}} coins",
      "watchAdCta": "Watch",
      "adRemaining": "{{n}} / {{max}} left today",
      "adDailyLimit": "Come back tomorrow for more ad coins.",
      "adCooldown": "Wait {{sec}}s",
      "adGranted": "+{{n}} coins from the ad!",
      "adFailed": "Ad didn't finish. Try again.",
      "adPreviewTitle": "Ad preview",
      "adPreviewBody": "Real rewarded ads play on the iOS/Android app. This is a short preview so you can test the shop.",
      "iapPreviewConfirm": "Add {{coins}} coins? (Preview — real App Store / Play billing on the mobile app.)\nPrice: {{price}}",
      "iapUnavailable": "In-app purchases aren't set up on this build yet.",
      "iapFailed": "Purchase failed. Try again.",
      "buy": "Buy",
      "owned": "Owned",
      ...
      "items": {
        ...
        "dailyUnlock7": "7-day daily unlock",
        "dailyUnlock7Desc": "Play any past daily calendar day free for 7 days",
        "dailyUnlock7Short": "7-Day",
        "dailyUnlock7Tag": "PASS",
        "xpBoost2x15": "XP 2× (15 min)",
        "xpBoost2x15Desc": "Double XP from play for 15 minutes",
        "xpBoost2x15Short": "XP ×2",
        "xpBoost2x15Tag": "15 MIN",
    ...
    "dailyCalendar": {
      ...
      "playDate": "PLAY {{date}}",
      "clearedToday": "TODAY'S PUZZLE CLEARED",
    ...
    "dailyStreak": {
      ...
      "daysLabel": "days",
      "howItWorks": "Clear today’s daily quiz each day to grow your streak.",
      "currentStreakLabel": "day streak",
      "freezeLabel": "freezes",
      "freezeExplain": "Miss exactly 1 day? One freeze keeps your streak. Miss 2+ days and it resets.",
  ...
  "ko": {
    ...
    "relatedWords": {
      ...
      "slotAria": "답 칸 {{n}}",
      "answerTtsOn": "정답 발음 켜짐 — 누르면 끔",
      "answerTtsOff": "정답 발음 꺼짐 — 누르면 켬",
      "swapPhoto": "다른 사진으로 바꾸기",
      "swapPhotoUsed": "이미 바꾼 사진",
      ...
      "hintLabel": "힌트",
      "hintAria": "코인 {{count}}개로 한 글자 열기",
      "hintTokenAria": "힌트권 1개로 한 글자 열기 (보유 {{count}})",
      "hintAdLabel": "광고 보기",
      "hintAdAria": "짧은 광고를 보고 한 글자 열기",
      "hintAdConfirm": "짧은 광고를 보고 한 글자를 열까요? (데모 — 광고는 재생되지 않아요.)",
      "hintInsufficient": "코인이 부족해요.",
      "hintInsufficientTokens": "힌트권이 부족해요.",
      "hintUnavailable": "더 열 글자가 없어요.",
      "chains": {
        "foodAnimals": "음식 · 동물",
        "skySeasons": "하늘 · 계절",
        "schoolHome": "학교 · 집",
    ...
    "match": {
      ...
      "comboLabel": "콤보",
      "bestCombo": "최고 콤보: {{n}}",
      "resultsDailyNextWord": "데일리 {{n}}일차 · 내일 자정(KST)에 새 단어",
    ...
    "profile": {
      ...
      "streakLine": "🔥 {{days}}일 한글 학습 연속",
      "streakStart": "오늘 한글 학습 연속을 시작해 보세요",
      "longestStreak": "최장 연속: {{days}}일",
    ...
    "matchTurn": {
      ...
      "turnNumber": "{{n}}턴",
      "roundTurn": "{{round}}라운드 · {{turn}}턴",
      "seriesScore": "시리즈 {{opp}}–{{my}}",
      "firstTo": "{{n}}승 선취",
      "roundWin": "라운드 승리! 🎉",
      "roundLoss": "라운드 패배",
      "roundPlayerWins": "{{name}} 승리",
      "roundEnded": "라운드 종료",
      "nextRound": "다음 라운드",
    ...
    "dailyGift": {
      "title": "출석 선물",
      "subtitle": "{{start}}–{{end}}일차 · {{week}}주차 — 매일 로그인하세요!",
      "returnTomorrow": "내일 다시 오면 다음 보상을 받을 수 있어요!",
      "streakBroken": "연속 출석이 끊겼어요 — 1일차부터 다시 시작!",
      "trackLabel": "7일 출석 보상 트랙",
      "dayLabel": "{{day}}일차",
      "today": "오늘",
      "tomorrow": "내일",
      "claim": "받기",
    ...
    "shop": {
      ...
      "tabGetCoins": "코인 충전",
      "packCoins": "코인 {{n}}개",
      "buyPack": "{{price}}로 코인 {{n}}개 구매",
      "packGranted": "코인 +{{n}}!",
      "packBadge": {
        "popular": "인기",
        "best": "가성비"
      },
      "watchAdTitle": "광고 보기 · 코인 +{{n}}",
      "watchAdCta": "보기",
      "adRemaining": "오늘 {{n}} / {{max}}회 남음",
      "adDailyLimit": "오늘은 광고 코인을 다 받았어요. 내일 다시 와요.",
      "adCooldown": "{{sec}}초 후 다시",
      "adGranted": "광고 보상 코인 +{{n}}!",
      "adFailed": "광고가 끝나지 않았어요. 다시 시도해 주세요.",
      "adPreviewTitle": "광고 미리보기",
      "adPreviewBody": "실제 보상형 광고는 iOS/Android 앱에서 재생됩니다. 지금은 상점 테스트용 짧은 미리보기예요.",
      "iapPreviewConfirm": "코인 {{coins}}개를 추가할까요? (미리보기 — 실제 결제는 모바일 앱에서)\n가격: {{price}}",
      "iapUnavailable": "이 빌드에는 인앱 결제가 아직 연결되어 있지 않아요.",
      "iapFailed": "결제에 실패했어요. 다시 시도해 주세요.",
      "buy": "구매",
      "owned": "보유함",
      "quantity": "보유: {{count}}개",
      "activeFor": "활성: {{time}}",
      ...
      "items": {
        ...
        "dailyUnlock7": "7일 데일리 언락",
        "dailyUnlock7Desc": "7일 동안 지난 데일리 캘린더를 무료로 플레이",
        "dailyUnlock7Short": "7일",
        "dailyUnlock7Tag": "패스",
        "xpBoost2x15": "XP 2배 (15분)",
        "xpBoost2x15Desc": "15분 동안 획득 XP 2배",
        "xpBoost2x15Short": "XP ×2",
        "xpBoost2x15Tag": "15분",
    ...
    "dailyStreak": {
      ...
      "daysLabel": "일",
      "howItWorks": "매일 데일리 퀴즈를 클리어하면 연속 일수가 쌓여요.",
      "currentStreakLabel": "일 연속",
      "freezeLabel": "프리즈",
      "freezeExplain": "하루만 빠지면 프리즈 1개로 스트릭을 지켜 줘요. 이틀 이상 빠지면 리셋돼요.",
